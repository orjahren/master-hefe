...
class FollowLeadingVehicle(BasicScenario):
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True,
        ...
        self._static_obstacle_location_offset = self._first_vehicle_location + 35 # Place static obstacle 35m ahead of trigger point
    ...
    def _initialize_actors(self, config):
        ...
        """
        # Leading vehicle
        waypoint_lv, _ = get_waypoint_in_distance(self._reference_waypoint, self._first_vehicle_location)
        transform_lv = waypoint_lv.transform
        transform_lv.location.z += 0.5
        first_vehicle = CarlaDataProvider.request_new_actor('vehicle.nissan.patrol', transform_lv)
        self.other_actors.append(first_vehicle)

        # Static obstacle (e.g., broken-down vehicle partially blocking the lane)
        static_obstacle_waypoint, _ = get_waypoint_in_distance(self._reference_waypoint, self._static_obstacle_location_offset)
        ...
        static_obstacle = CarlaDataProvider.request_new_actor('vehicle.carlamotors.carlacola', self._static_obstacle_transform)
        static_obstacle.set_simulate_physics(enabled=False) # Make it a static obstacle
        self.other_actors.append(static_obstacle) # This will be self.other_actors[1]
    ...
    def _create_behavior(self):
        ...
        sequence.add_child(ActorDestroy(self.other_actors[1])) # Destroy static obstacle
